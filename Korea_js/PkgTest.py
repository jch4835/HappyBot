...
try:
    ...
    # print(ACCESS_TOKEN)
    ACCESS_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0b2tlbiIsImF1ZCI6IjY0NTMyODY0LTY0Y2UtNDE3ZS04Y2U4LTYyMGJhYTdhMWM4MCIsInByZHRfY2QiOiIiLCJpc3MiOiJ1bm9ndyIsImV4cCI6MTc3NzExMzgxNCwiaWF0IjoxNzc3MDI3NDE0LCJqdGkiOiJQU2FGWlh2Mk5jUTRvb3JGSzlwOUhtSlZNcmpKS0VJaVNOZTMifQ.InnIUA0hBgY3BdvjqhjJeVCYp3YNXE5YASnFZ35eAmKgsV28frdHdjSLV7gzxltRC-0EhnvLbFFlWKKK3xpUgg"
    ...
    while True:
        ...
        t_buy = t_now.replace(hour=19, minute=47, second=0, microsecond=0)
        t_sell = t_now.replace(hour=19, minute=49, second=0, microsecond=0)
        t_exit = t_now.replace(hour=19, minute=50, second=0,microsecond=0)
